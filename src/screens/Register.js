...
import { registerUser } from "../redux-toolkit/slices/userSlice.js";
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <p className="text-red-600 mb-4 pl-2">
                  ...
                  {loading ? (
                    <button
                      disabled
                      className="py-4 w-full bg-gray-500  text-white font-bold rounded-full transition duration-200 cursor-not-allowed"
                    >
                      {/* loading please wait... */}
                      <Spinner
                        thickness="4px"
