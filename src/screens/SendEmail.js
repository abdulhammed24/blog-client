...
import { sendMailAction } from "../redux-toolkit/slices/emailSlices";
...
const SendEmail = () => {
  ...
  const toMail = currentLocation.state;
  // console.log(toMail);
  //dispath
  ...
  //redirect
  if (isMailSent) return <Navigate to={`/profile/${toMail?.id}`} />;
